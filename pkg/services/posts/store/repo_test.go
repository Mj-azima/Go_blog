...
const (
	...
	insertPost = `INSERT INTO "posts" ("created_at","updated_at","deleted_at","body",author_id) VALUES ($1,$2,$3,$4,$5) RETURNING "id"`
...
//	}{
//		"Happy path": {
//			expectQueryArgs:        []driver.Value{now, now, nil, body, u.ID},
...
//			response, err := repo.Create(test.input.Author, test.input.Body)
